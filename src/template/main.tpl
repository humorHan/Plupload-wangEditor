...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="/release/wang-editor/css/wangEditor.css">
...
<body style="padding-top: 50px;">
    ...
    <script type="text/javascript" src="/release/wang-editor/js/wangEditor.js"></script>
    <script type="text/javascript" src="/release/wang-editor/js/plugin/anchor-menu.js"></script>
